...
#ifndef BZIPFILTER_HH_INCLUDED
#define BZIPFILTER_HH_INCLUDED
...
struct basic_bzip2_compressor 
    : boost::iostreams::symmetric_filter<detail::bzip2_compressor_impl<Alloc>, Alloc> 
{
private:
...
struct basic_bzip2_decompressor 
    : boost::iostreams::symmetric_filter<detail::bzip2_decompressor_impl<Alloc>, Alloc> 
{
private:
...
#endif // #ifndef BZIPFILTER_HH_INCLUDED
